...
io.on("connection", async (socket) => {
  ...
  const userId__ = String(socket.handshake.query.userId);
  console.log("******************** JOIN ROOM:", userId, "TYPE: ", typeof userId__);
...
// Receive text message
  ...
  try {
    ...
    */
    console.log("Send message : map onlineUsers : ", onlineUsers);
    ...
    if (isUserOnline(Number(toUserId))){
      ...
      try {
          ...
          console.log("Notification :  activeChats map", activeChats);
...
async function getUsersList() {
  ...
  const users = [
      { id: 440, nickname: "Alice" },
      { id: 901, nickname: "Bob" },
      { id: 902, nickname: "Charly" },
      { id: 441, nickname: "Fanny" },
